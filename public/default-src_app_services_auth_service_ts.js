(self["webpackChunkdynamic_ui_ion"] = self["webpackChunkdynamic_ui_ion"] || []).push([["default-src_app_services_auth_service_ts"],{
...
let HttpService = class HttpService {
    ...
    handleError(error) {
        ...
        if (error instanceof rxjs__WEBPACK_IMPORTED_MODULE_3__.TimeoutError) {
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.throwError)('La lámpara no responde. Verifique su conexión.');
        }
...
let StorageService = class StorageService {
    ...
    store(storageKey, value) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield this.userData.next(value.user);
        });
    }
    get(storageKey) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__awaiter)(this, void 0, void 0, function* () {
